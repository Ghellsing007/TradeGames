...
export function Sidebar({ className, ...props }: SidebarProps) {
  ...
  return (
    <div
      className={cn("flex flex-col bg-sidebar text-sidebar-foreground border-sidebar-border", className)}
      {...props}
    />
  )
}
...
export function SidebarMenuItem({ className, ...props }: SidebarMenuItemProps) {
  return <div className={cn("mb-1 last:mb-0", className)} {...props} />
}
...
export function SidebarMenuButton({ className, asChild = false, isActive = false, ...props }: SidebarMenuButtonProps) {
  const Comp = asChild ? React.Fragment : "button"
  return (
    <Comp
      className={cn(
        "flex items-center w-full gap-2 px-3 py-2 rounded-md text-sm transition-colors",
        isActive
